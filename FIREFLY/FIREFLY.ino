/*
  ...
  Send the information to Grasshopper 3D via Frirefly.
  Display the read values and (if desired) the remapped values on the Serial Monitor.
...
void loop()
{
  ...
  sensorMap = map(sensorValue, 50, 550, 0, 255); //remap the value of the sensor to the value of the LED
